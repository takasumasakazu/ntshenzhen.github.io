...
helping to Chinese tech giant such as Xiaomi, Oppo and hacking AI robot.

I try to explain about that, Where Shanzhai come from? Investigate them
ecosystem and value in modern IoT development?
...
somebody sends pull request for you like to customize an offer, you can
choose
...
Many Chinese developers didn\`t have enough skill to use SoC, but they
can make cell phone from the PCBA. They are the origin of Shanzhai,
small but freedom unskilled developer make funny cell phone like Phone
with the shaver. Few thousand Shanzhai PCBA companies in Shanghai,
...
Shanzhai distributor also changed the name, they called IDH (Independent
...
team is smaller than Apple.One reason is Shanzhai.

Many Chinese tech giants, they outsourced the design of the smartphone
to IDH. Middle and low spec smartphone\`s are not designed by Xiaomi.
Xiaomi in-house designer focus only top-end model.

Example, Famous IDH Wiingtech design 83 million smartphone in 2017. And
...
That means if the company can quick time to market new tech (nearly new
SoC), that can make a profit. This is the market for Chinese Shanzhai
ecosystem, by tech giant and IDH.
...
City easy made communication robot, that robot small succeed in the
market, and City easy also sell only PCBA.

Why Cityeasy sell PCBA for copycat? In fact, Cityeasy robot is made by
Smartspeaker + Balancewheeler + Tablet, they compile commodity
technology, and make complicated product. Cityeasy access other hardware
design resource by PCBA, and Rip, Mix, Burn, then made them Original
product.
...
IDH and Shared IP are fit for Mass customization. The current modern
development board is also Open Source Hardware.
...
<https://gemba-pi.jp/post-179927>

ハードウェアのシリコンバレー深圳に学ぶ -Junichi Fujioka book 2016\
 Interview with Chinese entrepreneur for Kickstarter and Chinese
copycat\
 <https://medium.com/shenzhen-high-tour-by-makers/shanzhai-b9b718f6158a>

Why Shenzhen is amazing in the maker movement --- TAKASU Masakazu

<https://www.slideshare.net/takasu/why-shenzhen-is-amazing-in-maker-movement>
