...
I want to tell the good news about crowdfunding, called Quickstarter.
Kickstarter will launch new bland called Quickstarter, for, smaller,
Indie, Hobby project!
:::

::: {.section .e-content field="body"}
::: {.section .section .section--body .section--first .section--last name="11ed"}
::: {.section-divider}
...
You can see his talk on video in English.

And now the hot news is M5Stack. That new style ESP32 board is famous in
Japan, we Japanese meet about that product with 150 makers in Tokyo.

Them new product M5GO looks phenomenal.

I will make the party around Maker Faire Tokyo, called Akiparty.

4th August, please join my party on Akihabara.

::: {#6690 .graf .graf--mixtapeEmbed .graf-after--p name="6690"}
[**AkiParty 2016 Tokyo report-Fantastic Dance Party for Geeks (include 2
performance video)**\
...
2--3/July RaspberryPi distributor meeting Cambridge

7/July Nico-Tech Kanazawa(Japan)

8/July Maker Faire Hongkong(Not announced yet,,,,)

9/July STEM Tour in Hongkong
