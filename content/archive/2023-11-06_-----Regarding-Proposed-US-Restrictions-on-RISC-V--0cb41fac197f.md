...
.markup--p-anchor}で発表した。ツイートでは「この案はむしろアメリカのパワーを削ぐ」としている。

> [](https://twitter.com/bunniestudios/status/1721537520436150608)

以下\[[Regarding Proposed US Restrictions on
...
.markup--p-anchor}よう要請した（[上院からの最初の要請も](https://www.reuters.com/technology/us-china-tech-war-risc-v-chip-technology-emerges-new-battleground-2023-10-06/){.markup--anchor
.markup--p-anchor}参照）。
...
米国の経済的・軍事的利益は、特別な注目に値するものです。連邦政府はライセンス制度の強制でそれを実現するのではなく、
...
インテルとAMDは、オープンに文書化された "x86
"コンピュータ規格の独自実装を中心に構築されたアメリカの巨大産業です。アメリカに必要なのは、ARMホールディングスの独占に対する米国からの回答であり、その回答はRISC-Vを採用する米国企業への投資によってもたらされるでしょう。
...
バニー・ファンのブログ[bunniestudio.com](https://www.bunniestudios.com/blog/){.markup--anchor
.markup--p-anchor}は、[CC BY-SA 4.0
DEED](https://creativecommons.org/licenses/by-sa/4.0/){.markup--anchor
