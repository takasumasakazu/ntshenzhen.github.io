...
.markup--p-anchor}と、次回の申し込みフローについての説明
...
M5Stack) tour, and wrap-up session. Tour end until midnight.
...
**■ニコ技深圳観察会、および深圳の現状**\
[観察会の概要と過去の実績](https://medium.com/ecosystembymakers/about-e306f96168b8){.markup--anchor
.markup--p-anchor}は、[前回の日程](https://medium.com/ecosystembymakers/matome-all-d80e21b6100e){.markup--anchor
.markup--p-anchor}と[各訪問先のビデオ](https://medium.com/shenzhen-high-tour-by-makers/shenzhen-high-tour-for-makers-vol-7-apr-2017-f027e1e72f7c){.markup--anchor
.markup--p-anchor}などはこちらを参照ください。\
[2014年8月に最初の観察会](https://media.dmm-make.com/item/2027/){.markup--anchor
.markup--p-anchor}を実施したときは、深圳は「よくわからない場所」でした。中国でのネットの使い方も、深圳に入る方法も手探りで、僕は蛇口のフェリー口で一人一人を迎えていました。

今はググれば多くの深圳見学ツアーがあります。また、過去の参加者が今度は友人を深圳に引率しに来ることも頻繁に行われていて、たいへんに嬉しいです。[訪問のためのwiki](http://wikiwiki.jp/shenzhen/){.markup--anchor
.markup--p-anchor}や[ハウツー記事](https://tech.recruit-mp.co.jp/etc/shenzhen_2017-4_1/){.markup--anchor
.markup--p-anchor}、[中国でfacebook等が使えるSIMの買い方](http://shao.hateblo.jp/entry/2018-best-prepaid-sim-in-china){.markup--anchor
.markup--p-anchor}、[Wechat
Payの有効化方法](http://shao.hateblo.jp/entry/wechat-pay-for-japanese){.markup--anchor
.markup--p-anchor}、果ては[銀行口座開設で使える中国語](https://note.mu/geek_chainese/n/n1df9cf539dbb){.markup--anchor
.markup--p-anchor}まで網羅されています。これらのリンク先はすべて過去の参加者が公開したものです。
...
・申し込みフォームに**他の参加者に向けた自己紹介ブログエントリを必須**にします。（ブログやってない人はmediumやはてダ等に作ってください）\
