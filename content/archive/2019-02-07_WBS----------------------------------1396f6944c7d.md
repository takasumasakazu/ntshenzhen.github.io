...
WBS講義 深圳独自の知財システムとイノベーション、そしてオープンソース {#wbs講義-深圳独自の知財システムとイノベーションそしてオープンソース .p-name}
====================================================================
...
::: {.section .section .section--body .section--first .section--last name="0a36"}
::: {.section-divider}
...
### 早稲田ビジネススクール講義録画：深圳独自の知財システムとイノベーション、そしてオープンソースとハードウェアハッカー {#424a .graf .graf--h3 .graf--leading .graf--title name="424a"}

![](https://cdn-images-1.medium.com/max/800/1*aAXfI_LK1Qrm1kukeqBIBw.jpeg){.graf-image}
...
https://www.seshop.com/product/detail/1280](https://www.seshop.com/product/detail/1280){.markup--anchor
.markup--p-anchor}
...
**この書き出しは[2017年1月18日に公開](https://diamond.jp/articles/-/114504){.markup--anchor
.markup--p-anchor}された、ダイヤモンドの「知られざる深圳」の第１回だ。それまでの深圳の紹介は「工場がたくさん」や「中国のシリコンバレー」などが中心で、**ゼロから急に大きくなり若者が中心だから面白い**という取り上げは僕が最初で、この1400万人は統計調査1250万人の記憶違いだが、その手の単語で検索すると多くの「たぶん上の記事を見てから書いたんだろうな」という原稿がみつかる。\
...
.h-card} on [February 7, 2019](https://medium.com/p/1396f6944c7d).

[Canonical
link](https://medium.com/@tks/gongkai-1396f6944c7d){.p-canonical}
