---
title: "zGlue     SoC               "
aliases: ["/2019/03/zglue-soc/"]
slug: zglue-soc
date: 2019-03-16
---

zGlue、カスタムSoCを安価で早く作るベンチャー企業 {#zglueカスタムsocを安価で早く作るベンチャー企業 .p-name}
================================================
...
::: {.section .section .section--body .section--first .section--last name="b67a"}
::: {.section-divider}
...
### zGlue、カスタムSoCを安価で早く作るベンチャー企業 {#c68c .graf .graf--h3 .graf--leading .graf--title name="c68c"}
...
コミュニティの中心秋田先生が、[Facebookで解説](https://www.facebook.com/akita11/posts/2123027197775373){.markup--anchor
.markup--p-anchor}を書いている。

> 「カスタムSoCを1週間1000ドルで」というキャッチフレーズのzGlue (
> [zglue.com](http://zglue.com/?fbclid=IwAR35QyVrDmqhj9JGx7S3afJ0Cyaotg1MUyFQV22uMI4JEQbicaS_ykmIWZ8){.markup--anchor
> .markup--blockquote-anchor} )を先日訪問してきました。

> SoCとは、System on a
> Chipの略で、プロセッサとメモリ、無線通信などの、システムの構成要素（のほとんど）を一つのチップに載せてしまった半導体チップのことです。\
...
> zGlueは、SmartFabricと呼ぶチップがコア技術で、この上にChipletと呼ぶCSP/BGAパッケージのICを載せてカスタムSoCをつくります。その意味で、SoCというよりSiP
> (Silicon in Package)の一種のCoC (Chip on Chip)に近いといえます。
...
> もちろん配線遅延はSoCよりも大きく、高速信号伝送はには向かないのですが、そこはSoCと明らかにコストとTTM
> (Time to
> Market)が違うので棲み分けはできます。なおSmartFabric内の配線ルートは、高速のデジタル系と、低抵抗のアナログ系の二系統あるそうです。
...
![ユーザ会の様子](https://cdn-images-1.medium.com/max/800/1*mjADrNV22P8j-FDuQfWsYA.jpeg){.graf-image}
:::
:::
:::
:::
...
.h-card} on [March 16, 2019](https://medium.com/p/8b64f1816c43).

[Canonical
link](https://medium.com/@tks/zglue-8b64f1816c43){.p-canonical}
