...
-給水器、電子レンジ（ただし、オフィス内での食事は禁止。電子レンジは外側にあるので、どこかで食べてください）\
-継続的にオフィスを使用するまでのサポート\
-オフィスを提供している[创富港](https://bzsns.com.cn/){.markup--anchor
.markup--p-anchor}サービスによる貸し会議室サービスの紹介（様々なサイズがあり価格が違う。8名程度の部屋だと、9:00--12:00
or 14:oo-18:00の半日単位で借りて200RMBぐらい）

**できないこと**\
-管理人の許可を得ない使用\
-又借り、継続的な使用\
（ニコ技深圳と連携している[iMakerbase](https://imakerbase.com/){.markup--anchor
.markup--p-anchor}は日本人を含む深センでの起業をサポートしており、[実績が](https://twitter.com/GomiHgy/status/1699704162072850501){.markup--anchor
.markup--p-anchor}あります。\
また、オフィスを提供している[创富港](https://bzsns.com.cn/){.markup--anchor
.markup--p-anchor}サービスでは電話対応・荷物受け取りなどのバーチャルオフィスサービスを提供しており、いずれも紹介可能です）

カギを持っているメンバーが誰かいれば普通にドロップインで使えますので、利用を希望される方は村谷や高須にwechatでご連絡ください（Wechat:
yingzhao928773 Wechat:takasumasakazu）。

誰かのものではなく、ニコ技深圳コミュニティというコミュニティの場所としての性格を大事にしたいと考えています。（訪問ルールにあるとおり、アポイントメントなしの訪問はお断りしています）
...
2020年12月に、当初のSEGMAKER(赛格広場）から、別のメイカースペース华强北创客中心に移転,このときはコロナ禍で、テーブル１つの縮退運用となった。\
2021年01月に华强北创客中心がわずか1ヶ月で閉鎖され、すぐ中电迪富大厦内のメイカースペースに移転。\
2021--2024年2月まで中电迪富大厦でテーブル1つのみの縮退運用中に、メイカースペースの閉鎖を告げられる\
2024年03月から华强路A出口から徒歩5分の現在のオフィスを契約し、再オープン。

伊藤さんのブログ\
<https://aseiito.net/2017/04/12/shenzhen_2017_4/>\
2018年01月～月次報告をこのブログ +
ご挨拶させていただいた方々へのメールで行っています。\
メールご希望の方はこちらにご記入ください。
...
協賛金はオフィスの賃貸料、郵送その他の事務用品、イベント運営などに使用させております。\
月次報告とメールマガジンにスポンサー様からのご案内を掲載させていただいています。スポンサーご希望の方は
WeChat: takasumasakazu までご連絡ください。

また、テーブル賃貸のためのデポジットを以下の方々からお預かりしています。
...
2020年度デポジット
(コロナ禍で誰も来れてないこともあり、以後凍結中。refundの際は高須までお声がけください）\
英昭さん 500\
茂田さん 500\
荒井さん 500\
Sunasaji 200\
