...
失敗を恐れるシンガポール人気質を変えるSTEM教育 {#失敗を恐れるシンガポール人気質を変えるstem教育 .p-name}
==============================================
...
::: {.section .section .section--body .section--first name="6664"}
::: {.section-divider}
...
### 失敗を恐れるシンガポール人気質を変えるSTEM教育 {#7ccc .graf .graf--h3 .graf--leading .graf--title name="7ccc"}
...
::: {.section .section .section--body .section--last name="a076"}
::: {.section-divider}
...
::: {.section-content}
::: {.section-inner .sectionLayout--insetColumn}
### 受験戦争国家シンガポールで育まれる「キアスー」気質 {#c2ca .graf .graf--h3 .graf--leading name="c2ca"}
...
実際に効果は出ていて、経済協力開発機構（OECD）が3年に1度実施している「国際生徒評価のためのプログラム(PISA)」の[**最新版2015年度調査**](https://www.oecd.org/tokyo/newsroom/singapore-tops-latest-oecd-pisa-global-education-survey-japanese-version.htm){.markup--anchor
.markup--p-anchor}でシンガポールは世界トップ、それ以前の調査でも上位グループにあり、特に数学を中心にした理系科目に強みがある。シンガポールの閣僚も数学や医学、コンピュータサイエンスなどの修士／博士が多く、現在のリー・シェンロン首相はケンブリッジ大学のトリニティ・カレッジという、ニュートンなどを輩出した世界有数の数学スクールを首席で卒業している。
...
1.  [**すべての学生を、科学を好きにすること**]{#90fa}
2.  [**STEMはあくまで教育で、シンガポールの国力を向上する成果がきちんと出るものであること**]{#f64c}

を目指している」

STEM.INCの活動について語る、STEM.INC principalのGopal（字幕：高須正和）

### すべての学生を、科学を好きにすること {#17f0 .graf .graf--h3 .graf-after--figure name="17f0"}
...
### STEMはあくまで教育で、成果がきちんと出るものであること {#bca2 .graf .graf--h3 .graf-after--p name="bca2"}
...
### STEM.INCの成果とこれから {#dcd7 .graf .graf--h3 .graf-after--p name="dcd7"}
...
2017年は"Committee on the Future
Economy"として、未来のシンガポールに向けて注力すべき[**7つの提言**](http://www.straitstimes.com/singapore/committee-on-the-future-economy-outlines-7-strategies-to-take-singapore-forward){.markup--anchor
.markup--p-anchor}を、経済大臣を中心にしたグループがまとめた[**（全文PDF）**](https://www.gov.sg/~/media/cfe/downloads/cfe%20report.pdf?la=en){.markup--anchor
.markup--p-anchor}。「実際的な深いスキルを持つこと」や、「デジタルを強く活用すること」は、すべてのシンガポール人が求められている。

Maker FaireもSTEM.INCも、シンガポールでは「あたりまえ」のものになる」

### キアスーを超えていくシンガポール {#971f .graf .graf--h3 .graf-after--p name="971f"}

メンリム館長のシンガポールサイエンスセンターは、Maker
Faireシンガポールの運営主体でもある。STEM.Incの活動とMaker
Faireは、教育プログラムとアウトプット先としてつながっているし、科学を楽しませるという目的を共有している。
...
.h-card} on [March 23, 2025](https://medium.com/p/64cbbafbe2bb).

[Canonical
link](https://medium.com/@tks/20170510-64cbbafbe2bb){.p-canonical}
